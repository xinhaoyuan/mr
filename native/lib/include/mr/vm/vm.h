...
#define MR_SYMBOL_VM_EXCEPTION_REGS_OUT_OF_RANGE MR_SYMBOL_BOX(MR_SYMBOL_VM_OFFSET + 0)
#define MR_SYMBOL_VM_EXCEPTION_APPLY_ARGC_ERROR  MR_SYMBOL_BOX(MR_SYMBOL_VM_OFFSET + 1)
#define MR_SYMBOL_VM_EXCEPTION_APPLY_BAD_ENTRY   MR_SYMBOL_BOX(MR_SYMBOL_VM_OFFSET + 2)
#define MR_SYMBOL_VM_EXCEPTION_APPLY_NO_MEM      MR_SYMBOL_BOX(MR_SYMBOL_VM_OFFSET + 3)
#define MR_SYMBOL_VM_EXCEPTION_APPLY_UNSOLVED    MR_SYMBOL_BOX(MR_SYMBOL_VM_OFFSET + 4)
#define MR_SYMBOL_VM_EXCEPTION_BAD_INSTRUCTION   MR_SYMBOL_BOX(MR_SYMBOL_VM_OFFSET + 5)
